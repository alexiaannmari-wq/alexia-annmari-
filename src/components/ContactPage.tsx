      ...
      <section className="px-6 py-16 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <aside className="space-y-6">
            ...
            {siteConfig.pages.book.enabled && isExternalBookingEnabled() && (
              <div className="bg-secondary text-secondary-foreground rounded-md p-8">
                <ContentField
                  sourceId="pages.contact"
                ...
                <a
                  ...
                  rel={bookLink.rel}
                  className="bg-background text-foreground mt-5 inline-flex rounded-sm px-5 py-3 font-bold"
                >
                  {getBookCtaLabel()}
                </a>
              </div>
