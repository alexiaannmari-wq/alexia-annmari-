  ...
  return (
    <span className="group relative inline">
      ...
      {admin?.isEditMode && (
        <a
          href={withBase('/admin')}
          className="border-primary/30 bg-background text-primary ml-2 inline-flex items-center gap-1 rounded-sm border px-2 py-0.5 text-xs font-bold"
        >
...
export function SharedFieldHint() {
  ...
  return (
    <a
      href={withBase('/admin')}
      className="border-primary/30 bg-background text-primary inline-flex items-center gap-1 rounded-sm border px-3 py-1 text-xs font-bold"
    >
      <Settings2 className="h-3 w-3" />
      Edit in Site Settings
    </a>
