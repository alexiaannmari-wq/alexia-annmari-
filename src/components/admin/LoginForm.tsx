...
export default function LoginForm() {
  ...
  return (
    <div className="space-y-6">
      {isLocalDev && (
        <div className="bg-card space-y-4 rounded-md border border-border p-8">
          <div>
          ...
          <button
            ...
            className="bg-primary text-primary-foreground rounded-sm px-6 py-3 font-bold"
          >
      ...
      <form onSubmit={handleSubmit} className="bg-card space-y-5 rounded-md border border-border p-8">
        <div>
  ...
  return (
    <div className="bg-card rounded-md border border-border p-8">
      ...
      <button
        ...
        className="border-border mt-6 rounded-sm border px-5 py-2 text-sm font-bold"
      >
        Sign out
      </button>
    </div>
...
export function AdminNav() {
  ...
  return (
    <div className="flex flex-wrap gap-3">
      <a href={withBase('/admin')} className="rounded-sm border border-border px-4 py-2 text-sm font-bold">
        Dashboard
      </a>
      <a
        href={withBase('/admin/settings')}
        className="rounded-sm border border-border px-4 py-2 text-sm font-bold"
      >
        Site Settings
      </a>
      <a href={withBase('/admin/faq')} className="rounded-sm border border-border px-4 py-2 text-sm font-bold">
        FAQ
      </a>
      <a href={withBase('/admin/fees')} className="rounded-sm border border-border px-4 py-2 text-sm font-bold">
        Packages
      </a>
      <a href={withBase('/')} className="rounded-sm border border-border px-4 py-2 text-sm font-bold">
        View site
      </a>
      {admin.isAuthenticated && (
        <button
          ...
          className="bg-primary text-primary-foreground rounded-sm px-4 py-2 text-sm font-bold"
        >
          Enable edit mode
        </button>
      )}
