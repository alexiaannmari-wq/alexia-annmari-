      ...
      <div className="mx-auto max-w-3xl space-y-8 px-6 py-16">
        <div>
          ...
          <p className="text-muted-foreground mt-3 leading-relaxed">
            Sign in to edit site settings, FAQ items, packages, and page content. In production, changes are
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="bg-card rounded-md border border-border p-8">
            ...
            <button
              ...
              className="bg-primary text-primary-foreground mt-5 rounded-sm px-5 py-3 font-bold"
            >
              Enable edit mode
            </button>
          </div>
          ...
          {admin.lastCommitSha && !admin.isLocalMode && (
            <div className="bg-card rounded-md border border-border p-8 md:col-span-2">
