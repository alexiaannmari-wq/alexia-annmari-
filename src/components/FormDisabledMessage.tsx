...
export default function FormDisabledMessage({
  ...
  return (
    <div className="space-y-6 text-center">
      <div className="bg-primary/10 mx-auto flex h-16 w-16 items-center justify-center rounded-sm">
      ...
      <div className="flex flex-col justify-center gap-3 sm:flex-row">
        <a
          ...
          className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center gap-2 rounded-sm px-6 py-3 font-bold shadow-sm transition-colors"
        >
        ...
        {!isBasic && isPhoneEnabled() && (
          <a
            ...
            className="border-primary text-primary hover:bg-primary/10 inline-flex items-center justify-center gap-2 rounded-sm border px-6 py-3 font-bold transition-colors"
          >
