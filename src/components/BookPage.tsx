    ...
    >
      <section className="px-6 py-16 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <aside className="bg-secondary text-secondary-foreground h-fit rounded-md p-8">
          ...
          <div className="space-y-6">
            {modes.length > 1 && (
              <div className="bg-card grid gap-2 rounded-sm border border-border p-2 shadow-sm sm:grid-cols-2">
                {modes.map((mode) => (
                  <button
                    key={mode.id}
                    type="button"
                    ...
                    className={`rounded-sm px-5 py-3 text-sm font-bold transition-colors ${
                      activeMode === mode.id
            ...
            <div className="bg-card rounded-md border border-border p-6 shadow-sm md:p-8">
    ...
    >
      <section className="px-6 py-16 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="bg-card rounded-md border border-border p-8 shadow-sm md:p-10">
            <MarkdownText className="text-muted-foreground leading-relaxed">
              {externalLink.description}
            </MarkdownText>
            {externalLink.url?.trim() ? (
              <a
                href={externalLink.url.trim()}
                target="_blank"
                rel="noreferrer"
                className="bg-primary text-primary-foreground hover:bg-primary/90 mt-8 inline-flex w-full items-center justify-center gap-2 rounded-sm px-6 py-4 text-center font-bold shadow-sm transition-colors sm:w-auto"
              >
                {externalLink.label}
...
function ConsultationForm({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-primary text-primary-foreground hover:bg-primary/90 w-full rounded-sm px-6 py-3 font-bold shadow-sm transition-colors"
    ...
    <div className="space-y-2">
      <label className="space-y-2">
        ...
        <select
          ...
          className="border-border bg-background focus:border-primary w-full rounded-sm border px-4 py-3 outline-none transition-colors disabled:cursor-not-allowed disabled:opacity-60"
        >
          <option value="">
            {slotsState === 'loading'
    ...
    <div className="bg-card rounded-md border border-border p-6 shadow-sm md:p-8">
      <div className="space-y-4">
        ...
        {calendar.mode === 'serverless-google-api' && (
          <p className="text-muted-foreground rounded-sm bg-secondary/30 p-4 text-sm leading-relaxed">
  ...
  return (
    <div className="space-y-4 text-center">
      ...
      <button
        type="button"
        onClick={onReset}
        className="border-primary text-primary hover:bg-primary/10 rounded-sm border px-6 py-3 font-bold"
      >
  ...
  return (
    <label className="space-y-2">
      ...
      <input
        ...
        required={required}
        className="border-border bg-background focus:border-primary w-full rounded-sm border px-4 py-3 outline-none transition-colors"
      />
    </label>
  );
}
  ...
  return (
    <label className="space-y-2">
      ...
      <textarea
        ...
        rows={rows}
        required={required}
        className="border-border bg-background focus:border-primary w-full resize-none rounded-sm border px-4 py-3 outline-none transition-colors"
      />
    </label>
  );
}
