        ...
        <div className="flex flex-col gap-3 border-b border-border p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="hidden gap-2 sm:flex">
            <button
              ...
              className="border-border hover:bg-secondary/40 rounded-sm border p-2 transition-colors disabled:cursor-not-allowed disabled:opacity-40"
            ...
            <button
              ...
              className="border-border hover:bg-secondary/40 rounded-sm border p-2 transition-colors"
            ...
            {dayBusy.map((interval) => {
              ...
              return (
                <div
                  ...
                  className="absolute left-2 right-2 rounded-sm bg-muted/70"
                  style={{
                    top: `${position.top}%`,
            ...
            {daySlots.map((slot) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    'absolute left-2 right-2 z-10 rounded-sm border px-2 py-1 text-center text-xs font-bold shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2',
                    isSelected
